...
$stmt = $bdd->prepare("SELECT intervention.id AS idInt, incident.id AS idTicket, "
        . "priorite.nom AS prioritename, etat,"
        . " machine.nom AS machinename, dateSignalisation FROM intervention "
...
foreach ($dataInterv as $uneInterv) {
    $idInt = $uneInterv['idInt'];
    $idTicket = $uneInterv['idTicket'];
    ...
    $cadreInterv = "<a href='index.php?pageType=intervTicket&idTicket=".$idTicket."&idInt=".$idInt."''><div class='cadre".$couleur."'>"
                      . "<span><span>Nom de machine : </span> $nomMachine</span><br /><br />"
                      . "<span><span>Date de l'incident : </span> $dateSignal</span><br /><br /> "
                      . "<span class='prio'><span>Priorité:</span> $priorite</span><br /><br /><br /> "
