...
foreach ($dataTicketUser as $unTicket) {
    ...
    $cadreTicket .= "<form method='POST' action='../modele/listeTicketGestion_vue.php'>"
                    ...
                    . "</form>";
    $cadreTicket .= "<span><a href='index.php?pageType=globalTicketG&idTicket=$idTicket'><img src='../assets/img/logo.png' alt='logo'></a></span><br />";
    $cadreTicket .= "<span><a href='javascript:selection($idTicket);'><img src='../assets/img/logo.png' alt='logo'></a></span><br />";
